...
# run this file with
# python MLP_train.py -metrics 'acc' 'macro-f1' -model MLP -metric_choose 'macro-f1' -setting seed_sub_dependent_train_val_test_setting -dataset_path /data1/cxx/SEED数据集/SEED/ -dataset seed_raw -sample_length 200 -stride 200 -only_seg -batch_size 256 -epochs 100 -seed 2024 -lr 0.001 -onehot >MLP/b256e100l001.log
...
def main(args):
    ...
    for rridx, (data_i, label_i) in enumerate(zip(data, label), 1):
        ...
        for ridx, (train_indexes, test_indexes, val_indexes) in enumerate(zip(tts['train'], tts['test'], tts['val']), 1):
            ...
            model = Model['MLP'](channels, feature_dim, num_classes)
            ...
            output_dir = make_output_dir(args, "MLP")
